    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        ...
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem laborum nulla ullam maiores ex, 
            hic quis veniam modi dicta, qui impedit. Hic repudiandae maxime maiores, 
            earum delectus quos est obcaecati?</p>
        </div>
      ...
      <p className='text-center text-white/60 md:text-sm text-xs py-4'>
        Copyright 2026 © Nagasai. All Right Reserved
      </p>
