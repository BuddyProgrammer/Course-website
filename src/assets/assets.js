...
import java_course_thumbnail from './java_course.png'
...
export const dummyCourses = [
  ...
  courseTitle: "Java Programming Complete Guide",

  courseDescription: "<h2>Learn Java Programming From Scratch</h2>\
  <p>This course helps beginners learn Java programming from basic syntax to advanced concepts.</p>\
  <p>You will learn Object Oriented Programming, Exception Handling, Collections, and build real-world projects.</p>\
  <ul>\
  ...
  courseThumbnail: java_course_thumbnail,
  ...
  courseContent: [
    ...
    {
      chapterId: "java_chapter_1",
      chapterOrder: 1,
      chapterTitle: "Java Introduction",

      chapterContent: [
        {
          lectureId: "java_lecture_1",
        ...
        {
          lectureId: "java_lecture_2",
          lectureTitle: "Installing JDK and IDE",
          lectureDuration: 15,
          lectureUrl: "https://youtu.be/A74TOX803D0",
          isPreviewFree: false,
          lectureOrder: 2
        }
      ]
    ...
    {
      chapterId: "java_chapter_2",
      chapterOrder: 2,
      chapterTitle: "Object Oriented Programming",

      chapterContent: [
        {
          lectureId: "java_lecture_3",
          lectureTitle: "Classes and Objects",
          lectureDuration: 20,
          lectureUrl: "https://youtu.be/pTB0EiLXUC8",
          isPreviewFree: true,
          lectureOrder: 1
        },
        {
          lectureId: "java_lecture_4",
    ...
    {
      chapterId: "java_chapter_3",
      chapterOrder: 3,
      chapterTitle: "Exception Handling",

      chapterContent: [
        {
          lectureId: "java_lecture_5",
          lectureTitle: "Try Catch Block",
          lectureDuration: 15,
          lectureUrl: "https://youtu.be/cvM9kK2Q3rU",
          isPreviewFree: true,
          lectureOrder: 1
        }
      ]
